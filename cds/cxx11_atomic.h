...
@endcond
    ...
    <a href="http://boost.org">boost</a> library contains an implementation of atomic
    started in version 1.53.
    Unfortunately, this implementation is not fully conformed to C++11 standard and cannot
    be used with <b>libcds</b>.
*/
